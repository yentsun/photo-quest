 ...
 * @readonly
 * @type {{ RAYS: 'rays', ARROWS: 'arrows', HEARTS: 'hearts' }}
 */
export const EFFECT_TYPE = {
  ...
  ARROWS: 'arrows',
  /** Doodle hearts bubbling up from a circle the user places on the photo. */
  HEARTS: 'hearts',
};
...
export const EFFECT_TYPE_OPTIONS = [
  ...
  { value: EFFECT_TYPE.HEARTS, label: 'Hearts' },
];
...
export const EFFECT_COUNT = {
  ...
  [EFFECT_TYPE.HEARTS]: { default: 6, min: 3, max: 14 },
};
