...
const paths = {
  ...
  database: { d: 'M4 6c0-1.657 3.582-3 8-3s8 1.343 8 3-3.582 3-8 3-8-1.343-8-3zm0 0v12c0 1.657 3.582 3 8 3s8-1.343 8-3V6m0 6c0 1.657-3.582 3-8 3s-8-1.343-8-3', stroke: true },
  ...
  zoomIn: { d: 'M11 19a8 8 0 100-16 8 8 0 000 16zM21 21l-4.35-4.35M11 8v6M8 11h6', stroke: true },
  zoomOut: { d: 'M11 19a8 8 0 100-16 8 8 0 000 16zM21 21l-4.35-4.35M8 11h6', stroke: true },
  ...
  sparkles: { d: 'M11 3l1.7 4.8L17.5 9.5l-4.8 1.7L11 16l-1.7-4.8L4.5 9.5l4.8-1.7L11 3zM18.5 14l.9 2.1 2.1.9-2.1.9-.9 2.1-.9-2.1-2.1-.9 2.1-.9.9-2.1z', stroke: true },
  wrench: { d: 'M14.7 6.3a1 1 0 000 1.4l1.6 1.6a1 1 0 001.4 0l3.77-3.77a6 6 0 01-7.94 7.94l-6.91 6.91a2.12 2.12 0 01-3-3l6.91-6.91a6 6 0 017.94-7.94l-3.76 3.76z', stroke: true },
  kebab: { d: 'M10.5 5a1.5 1.5 0 1 0 3 0a1.5 1.5 0 1 0 -3 0zM10.5 12a1.5 1.5 0 1 0 3 0a1.5 1.5 0 1 0 -3 0zM10.5 19a1.5 1.5 0 1 0 3 0a1.5 1.5 0 1 0 -3 0z', fill: true },
};
