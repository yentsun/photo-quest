...
export default function EmptyState({ title, description, action, icon }) {
  return (
    <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center', minHeight: '40vh', padding: 16, gap: space.gap }}>
      {icon && <View style={{ marginBottom: 8, color: colors.textMut }}>{icon}</View>}
