...
**4.11** Viewing an inventory card passively infuses it: **1 Đ per 10 seconds** in card view, **2 Đ per 10 seconds** in full media view (F key). The infusion counter updates live.
